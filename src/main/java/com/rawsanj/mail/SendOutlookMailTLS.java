...
public class SendOutlookMailTLS {
   public static void main(String[] args) {
      // Recipient's email ID needs to be mentioned.
      String to = "sendToAddress@example.com";//change accordingly

      // Sender's email ID needs to be mentioned
      String from = "sendFromAddress@outlook.com";//change accordingly
      
      final String username = "sendFromAddress@outlook.com";//change accordingly
      ...
      // Set Subject: header field
         ...
         message.setText("Hello, this is sample email to check/send "
            + "email using JavaMailAPI from Outlook");
